...
const std::string Dialogue::DALE_ARCHITECTURE = "";
const std::string Dialogue::DALE_TRAITS[6] = {
	"","","",
	"","","" };
...
const std::string Dialogue::REMY_ARCHITECTURE = "";
...
const std::string Dialogue::TODD_ARCHITECTURE = "";
...
const std::string Dialogue::MAGNUM_ARCHITECTURE = "";
